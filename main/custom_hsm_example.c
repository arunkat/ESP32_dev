...
static const char* const COMMON_NAME = "custom-hsm";
const char* HSM_CERTIFICATE = NULL;
const char* HSM_PRIVATE_KEY = NULL;
...
HSM_CLIENT_HANDLE custom_hsm_create()
{
    ...
    else
    {
        ...
        hsm_info->certificate = HSM_CERTIFICATE;
        hsm_info->key = HSM_PRIVATE_KEY;
        hsm_info->common_name = COMMON_NAME;
        hsm_info->endorsment_key = NULL;
